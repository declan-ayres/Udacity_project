...
def composite2():
        classified_files = open('equation_files')
        list_of_files = []
        for line in classified_files:
                line = line.rstrip('\n')
                list_of_files.append(line)
        draw_composite(list_of_files)
...
def draw_composite(list_of_files):
	images_list = []
	cntr1 = 0
	cntr2 = 0
...
if __name__ == '__main__':	
    ...
    parser.add_argument('--project_composite',dest='project_composite', action='store_true')
    parser.add_argument('--no_project_composite', dest='project_composite', action='store_false')
    ...
    number = args.number
    project_composite = args.project_composite
